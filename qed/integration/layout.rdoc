...
A seed is a directory that contains a README document, a Sowfile
...
and copies the files from the scaffold to staging ground, which is
...
And that's it. That is the basic outline of Sow seed. The nice thing
about seeds is that the layout is straight-forward and the 
